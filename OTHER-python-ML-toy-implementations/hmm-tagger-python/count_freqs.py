...
class Hmm(object):
    ...
    def train(self, corpus_file):
        ...
        for ngram in ngram_iterator: # this returns a n-gram of words and tags (e.g., trigram)
            ...
            tagsonly_ngram = tuple([ne_tag for word, ne_tag in ngram]) #retrieve only the tags
            ...
            if ngram[-1][0] is not None: # If this is not STOP (the last word in a sentence).
                ...
                self.word_tag_emission_counts[ngram[-1]] += 1 # and emission frequencies
    ...
    def write_counts(self, output, printngrams=[1,2,3]):
        ...
        for word, ne_tag in self.word_tag_emission_counts:            
            output.write("%i WORDTAG %s %s\n" % (self.word_tag_emission_counts[(word, ne_tag)], ne_tag, word))
    ...
    def read_counts(self, corpusfile):
        ...
        for line in corpusfile:
            ...
            if parts[1] == "WORDTAG":
                ne_tag = parts[2]
                word = parts[3]
                self.word_tag_emission_counts[(word, ne_tag)] = count
